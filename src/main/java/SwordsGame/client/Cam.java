...
public class Cam {
    ...
    public void update(Win window, ChMgr chunkManager, Rdr renderer, boolean blockVerticalEdgeScroll) {
    ...
    private void clampPosition(ChMgr chunkManager, Rdr renderer) {
        float blockSizeUnits = Wld.BLOCK_SIZE * 2.0f;
