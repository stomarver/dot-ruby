...
public class Renderer {
    ...
    private static final float DEFAULT_SUN_PITCH = 30.0f;

    private int viewportX = VIEWPORT_MARGIN_X;
    private int viewportY = 0;
    private int viewportWidth = 720;
    private int viewportHeight = 540;
    private final FogEnvironmentCalculator fogEnvironmentCalculator = new FogEnvironmentCalculator();
    private final Vector3f tempSunDirection = new Vector3f();
    private final Vector3f tempAmbient = new Vector3f();
    private final Vector3f tempDiffuse = new Vector3f();
    ...
    public void setSunDirection(float x, float y, float z) {
        fogEnvironmentCalculator.setSunDirection(x, y, z);
    }
    ...
    public void applySunLight() {
        Vector3f sunDirection = fogEnvironmentCalculator.getSunDirection(tempSunDirection);
    ...
    private void setupLighting() {
        ...
        Vector3f ambient = fogEnvironmentCalculator.getAmbient(tempAmbient);
        Vector3f diffuse = fogEnvironmentCalculator.getDiffuse(tempDiffuse);
        float[] ambientLight = { ambient.x, ambient.y, ambient.z, 1.0f };
        float[] diffuseLight = { diffuse.x, diffuse.y, diffuse.z, 1.0f };
