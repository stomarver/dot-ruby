...
public class MeshBuffer {
    ...
    private MeshBuffer(int vboId, int vertexCount) {
        this.vboId = vboId;
        this.vertexCount = vertexCount;
    }

    public static MeshBuffer build(FloatCollector collector) {
        ...
        return new MeshBuffer(vboId, collector.size() / STRIDE_FLOATS);
    }
